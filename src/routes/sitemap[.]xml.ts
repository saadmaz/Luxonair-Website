    ...
    handlers: {
      GET: async () => {
        ...
        const entries: Entry[] = [
          ...
          { path: "/holidays", changefreq: "monthly", priority: "0.7", lastmod: today },
          { path: "/deals", changefreq: "weekly", priority: "0.9", lastmod: today },
          { path: "/flights", changefreq: "monthly", priority: "0.7", lastmod: today },
          { path: "/flight-offers", changefreq: "weekly", priority: "0.7", lastmod: today },
